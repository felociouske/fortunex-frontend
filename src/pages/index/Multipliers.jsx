...
const features = [
  { icon: Zap, title: "Amplified returns", desc: "A multiplier of 5x means a 1% market move generates a 5% return on your stake." },
  { icon: ShieldCheck, title: "Protected downside", desc: "Optional stop-loss limits your loss to your stake — no negative balance." },
  { icon: BarChart3, title: "No margin calls", desc: "You can never lose more than the amount you put in, even with high multipliers." },
]

const levels = [
  { label: "x5", desc: "Low multiplier — smaller gains and losses, good for learning." },
  { label: "x10", desc: "Balanced exposure — moderate leverage for intermediate traders." },
  { label: "x20", desc: "Higher multiplier — for more experienced, active traders." },
  { label: "x50", desc: "Maximum exposure — fast-moving, suitable only for experienced traders." },
]
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#050814", color: "white", paddingTop: 72 }}>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", inset: 0, pointerEvents: "none", background: "radial-gradient(circle at 30% 30%, rgba(79,255,200,0.06), transparent 30%)" }} />
        <div style={{ maxWidth: 1180, margin: "0 auto" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 style={{ fontSize: "clamp(42px, 6vw, 74px)", fontWeight: 800, lineHeight: 1.0, marginBottom: 24 }}>
              More exposure.<br />Capped risk.
            </h1>
            <p style={{ fontSize: 17, color: "rgba(255,255,255,0.7)", maxWidth: 520, lineHeight: 1.85, marginBottom: 36 }}>
              Multipliers amplify your market exposure without the risk of losing more than your stake. Choose your multiplier, set your direction, and manage your position in real time.
            </p>
      ...
      <section style={{ padding: "0 28px" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto" }}>
          <div style={{ maxWidth: 800, margin: "-20px auto 0 auto", borderRadius: 28, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", overflow: "hidden" }}>
            <img
              src="/images/multipliers-placeholder.png"
              alt="Multipliers interface profit and loss example"
      ...
      <section style={{ padding: "80px 28px" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(28px, 3vw, 40px)", fontWeight: 800, marginBottom: 36 }}>Available multiplier levels</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
            {levels.map((l, i) => (
              <motion.div
                ...
                style={{ padding: 28, borderRadius: 20, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", textAlign: "center" }}
              >
                <p style={{ fontSize: 36, fontWeight: 800, color: "#ff4f6f", margin: "0 0 12px" }}>{l.label}</p>
                <p style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", lineHeight: 1.75, margin: 0 }}>{l.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
